...
public class EmployeeController {
   ...
   public ResponseEntity<String> getAllEmployees(
      ...
      String result = employeeService.getAllEmployees(page, size);
      return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(result);
   }

   @Operation(summary = "Get employee by ID", description = "Retrieve employee details by ID")
   @GetMapping("/{id}")
   public ResponseEntity<String> getEmployeeById(@PathVariable String id) throws IOException {
      String result = employeeService.getEmployeeById(id);
      return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(result);
   }
   ...
   public ResponseEntity<String> aggregateEmployees(@RequestParam String field, @RequestParam String fieldValue, @RequestParam String metricType, @RequestParam String metricField) throws IOException {
